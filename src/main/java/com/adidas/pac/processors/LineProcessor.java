...
public class LineProcessor {
	...
	private static final PaymentRulesProcessor paymentRulesProcessor  = PaymentRulesProcessor.getInstance();
	private static final PaymentRulesProcessor paymentSessionProcessor = PaymentSessionProcessor.getInstance();
